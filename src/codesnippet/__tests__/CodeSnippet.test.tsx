...
describe('CodeSnippet', () => {
  it('should render', () => {
    const { container } = render(<CodeSnippet value="CodeSnippet value" />);
    expect(container.querySelector('code')).toBeInTheDocument();
  });
  it('should allow to pass a value', () => {
    render(<CodeSnippet className="code" value="Code snippet text" />);
    expect(screen.getByText('Code snippet text')).toBeInTheDocument();
  });
  it('should allow to pass a child component', () => {
    render(
      <CodeSnippet className="code">
        <p>Code snippet text</p>
      </CodeSnippet>
    );
    expect(screen.getByText('Code snippet text')).toBeInTheDocument();
  });
  ...
  it('should contains a class called dcx-code', () => {
    const { container } = render(<CodeSnippet value="Code snippet value" />);
  ...
  it('should contains the class dcx-code and the class decided by the developer', () => {
    const { container } = render(
      <CodeSnippet className="my-classname" value="Code snippet value" />
    );
    expect(container.querySelector('.dcx-code')).toBeInTheDocument();
