...
describe('AccordionTitle', () => {
  ...
  it('should apply the titleClassName', () => {
    const { getByText } = render(<AccordionTitle title="Test Title" titleClassName="test-class" />);
    expect(getByText('Test Title')).toHaveClass('test-class');
  });

  it('should render the expandIcon', () => {
    const { container } = render(<AccordionTitle title="Test Title" expandIcon={<span>▼</span>} />);
