...
describe('KeyboardInput', () => {
  ...
  it('should render child components', () => {
    render(
      <KeyboardInput className="additional classes" id="user-defined-id">
        <p>text</p>
      </KeyboardInput>
    );
    expect(screen.getByText('text')).toBeInTheDocument();
  ...
  it('should have the class dcx-keyboard-Input if the user does not specify any additional class', () => {
    render(<KeyboardInput value="ctrl+p" id="user-defined-id" />);
  ...
  it('should be able to pass some extra properties', () => {
    ...
    const keyboadInputElement = container.getElementsByClassName(
      'dcx-keyboard-Input'
    );
  ...
  it('should be able to pass an id', () => {
    const { container } = render(
      <KeyboardInput value="ctrl+p" id="user_defined_id" />
    );
