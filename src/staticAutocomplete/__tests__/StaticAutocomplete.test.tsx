...
import { StaticAutocomplete, StaticAutocompleteErrorPosition } from '../';
...
describe('StaticAutocomplete', () => {
  ...
  it('should select the default value if progressive enhancement is enable', () => {
    ...
    render(
      <StaticAutocomplete options={['daniele', 'isaac']} defaultValue="isaac" />
    );
  ...
  it('should display an error', () => {
    render(
      <StaticAutocomplete
        ...
        errorId="errorId"
        errorPosition={StaticAutocompleteErrorPosition.AFTER_HINT}
      />
    );
  ...
  it('should display an error after the label', () => {
    render(
      <StaticAutocomplete
        ...
        errorMessageClassName="errorMessageClass"
        errorId="errorId"
        errorPosition={StaticAutocompleteErrorPosition.AFTER_LABEL}
      />
    );
    const label: any = screen.getByText('errorMessageText');
    expect(label.className).toBe('dcx-error-message errorMessageClass');
  ...
  it('should display an error before the label', () => {
    render(
      <StaticAutocomplete
        ...
        errorMessageClassName="errorMessageClass"
        errorId="errorId"
        errorPosition={StaticAutocompleteErrorPosition.BEFORE_LABEL}
      />
    );
    const label: any = screen.getByText('errorMessageText');
    expect(label.className).toBe('dcx-error-message errorMessageClass');
  ...
  it('should allow to specify an id for the input', () => {
    ...
    render(<StaticAutocomplete options={['daniele', 'isaac']} id="myId" />);
  ...
  it('should display the formInput content', () => {
    //@ts-ignore
    jest.spyOn(hooks, 'useHydrated').mockImplementation(() => true);
    render(<StaticAutocomplete options={['daniele', 'isaac']} />);
  ...
  it('should not display available options', async () => {
    const user = userEvent.setup();
    const { container } = render(
      <StaticAutocomplete options={['first', 'isaac']} />
    );
    const input = screen.getByRole('combobox');
  ...
  it('should allow to select the first item', async () => {
    const user = userEvent.setup();
    render(<StaticAutocomplete options={['daniele', 'destiny', 'isaac']} />);
    const input: any = screen.getByRole('combobox');
  ...
  it('should set the input to an empty string when there is no text in the input and on pressing Enter', async () => {
    render(<StaticAutocomplete options={['daniele', 'darren', 'isaac']} />);
  ...
  it('should accept tabIndex attribute', () => {
    render(<StaticAutocomplete options={['daniele', 'isaac']} tabIndex={1} />);
  ...
  it('should accept an option list of objects', async () => {
    ...
    render(<StaticAutocomplete options={options} search={quickSearch} />);
    const input = screen.getByRole('combobox');
