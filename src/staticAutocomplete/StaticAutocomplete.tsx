...
import { ErrorMessage, Hint, useHydrated, debounce } from '../common';
...
type staticAutocompleteProps = {
   ...
   */
  errorPosition?: StaticAutocompleteErrorPosition;
  /**
   * error message text
   */
...
export enum StaticAutocompleteErrorPosition {
