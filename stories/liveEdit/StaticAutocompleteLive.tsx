...
const StaticAutocompleteDemo = `
function StaticAutocompleteDemo() {
...
const StaticAutocompleteLive = () => {
  const scope = { StaticAutocomplete };
  return (
    <LiveProvider code={StaticAutocompleteDemo} scope={scope}>
