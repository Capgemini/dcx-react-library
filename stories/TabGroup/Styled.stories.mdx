...
In this section we're using the Tabs component providing the **material style** passing the relative `className`. Feel free to use your own css and style the Tab as you prefer

### A basic table with GovUK style

<Canvas>
  <Story name="styled-tabs-GovUK">
    {() => {
      return (
        <TabGroup
