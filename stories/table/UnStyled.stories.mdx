...
### An example with 'orderBy'

in the following example we enable the search functionlity passing - _withOrderBy_ -
...
<Canvas>
  <Story name="orderBy">
    {() => {
      ...
      return <Table dataSource={data} handleCellClick={handleCellClick} withOrderBy={true}/>;
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="custom-header">
    {() => {
      ...
      return <Table dataSource={data} handleCellClick={handleCellClick} withSearch={true}   customHeaderLabels={['Test', 'position', 'name', 'weight', 'symbol', 'actions']}/>;
    }}
  </Story>
</Canvas>

### An example with Custom Row

in the following example we display a custom row (it could be whatever attribute needed like className, id, etc) - _trProps_ -
...
<Canvas>
  <Story name="custom-row">
    {() => {
      ...
      return <Table dataSource={data} handleCellClick={handleCellClick} withSearch={true} trProps={[{className: 'errorRow'}]}/>;
    }}
  </Story>
</Canvas>
