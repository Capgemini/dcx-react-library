...
In this section we are using the CheckboxGroup component providing the GOV.UK Design System styles by passing the relative `className`. Feel free to use your own css and style the CheckboxGroup as you prefer

<Canvas>
  <Story name="multiple checkboxes with shared styles">
    {() => {
