...
Note that there is the option to add a Paginator at the bottom of the table. This uses the Paginator component which is also part of this library. For more information see the Paginator documentation.
