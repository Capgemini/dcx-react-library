...
import * as CharacterCountStories from './UnStyled.stories';

<Meta title="DCXLibrary/Form/CharacterCount/Documentation" />
...
When you import the character count component without providing any className or style associated will looks as following:

<Canvas of={CharacterCountStories.Unstyled} />
...
The CharacterCount component shows users the limit on characters or words to be entered in a textarea element.  
The component consists of the label for the textarea, optional hint, the textarea and a message advising the user of the remaining characters.  
...
<ArgTypes of={CharacterCountStories} />
